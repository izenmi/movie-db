...
export function HomePage() {
  ...
  useSeo({
    description:
      state.status === "ready"
        ? `邦画・洋画・アニメ映画${state.data.works}作品を制作会社・監督・脚本・キャスト・公開年・受賞歴・テーマから検索できるファンデータベース。`
        : undefined,
    jsonLd: {
  ...
  return (
    <div className="page">
      <div className="home-hero">
        <h1 className="font-display">映画DB</h1>
        <p className="page-subtitle">邦画・洋画・アニメ映画を制作会社・監督・キャスト・公開年から探せるデータベース</p>
        <p className="home-intro">
          次に観る映画探しに使えるデータベースです。テーマ・制作会社・監督・キャスト・公開年代などで絞り込めます。
        </p>
      </div>
      ...
      <p className="source-note">
        本サイトの記述はWikipedia日本語版・TMDb等の公開情報を参考に独自にまとめたものです。詳しくは
