...
export function RecommendPage() {
  ...
  useSeo({
    title: "好みからおすすめ",
    description:
      "好きなテーマや作品を3つまで選ぶと、傾向の近い作品を一致度つきで20本おすすめします。",
    jsonLd: breadcrumbJsonLd([
      { name: "映画DB", path: BASE_PATH },
  ...
  return (
    <div className="page">
      ...
      <p className="page-subtitle">
        {isItemMode
          ? `好きな作品を${MAX_TAGS}つまで選ぶと、傾向の近い作品を一致度つきで${RECOMMEND_COUNT}本おすすめします。`
          : `好きなテーマを${MAX_TAGS}つまで選ぶと、傾向の近い作品を一致度つきで${RECOMMEND_COUNT}本おすすめします。`}
      </p>
