...
const BADGES = [
  { label: "作品", value: counts.works, color: "#ffc85c" },
  { label: "制作会社", value: counts.studios, color: "#8adcae" },
  { label: "キャスト", value: counts.actors, color: "#f68fbe" },
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .glow--1 { width: 520px; height: 520px; top: -180px; right: -140px; background: #e9b44e; }
...
<body>
  ...
  <div class="badge">映</div>
  <h1>映画DB</h1>
  <p class="tagline">邦画・洋画・アニメ映画を制作会社・監督・キャストから探せるデータベース</p>
  <div class="stats">
    ${BADGES.map(
